// Package service @Author:冯铁城 [17615007230@163.com] 2026-01-07 15:09:20
package service
...
// LogService 日志Service
type LogService struct {
}

// NewLogService 创建日志Service实例
func NewLogService() *LogService {
	return &LogService{}
}

// UploadLogs 上传日志
func (l *LogService) UploadLogs(logDto model.LogDto, projectId string, loggerId string, cfg *config.Config) {
